...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ 
    ...
    const variants = {
      ...
      ghost: 'bg-[rgba(15,23,32,0.06)] text-[#0f1720] hover:bg-[rgba(15,23,32,0.1)]',
      outline: 'border border-[rgba(15,23,32,0.12)] bg-white text-[#0f1720] hover:bg-[rgba(15,23,32,0.04)]',
